...
<head>
    ...
    <title>Quirx - Delete Video</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container mt-3">
        <h1 class="mb-4 heading">Delete video</h1>

        <div class="mb-4">
            <h1><?php echo 'Are you sure you want to delete this video?' ?>
            </h1>
            <!-- create a form with yes and no -->
            <form action="../includes/delete_video.inc.php" method="POST">
                ...
                <a href="./user_dashboard.php" class="btn btn-lg btn-primary">No</a>
            </form>
